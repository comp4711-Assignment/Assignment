...
$route['player/(:any)'] = 'playerscontroller/display/$1';
$route['player'] = 'welcome';
$route['gameplay'] = 'gameplaycontroller/display';
$route['gameplay/sell'] = 'gameplaycontroller/sell';
$route['gameplay/buy'] = 'gameplaycontroller/buy';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
